...
class UserController extends Controller
{
    ...
    public function redirectProvider($social)
     ...
     public function loginClient(Request $request){
        ...
        {
            return back()->with('error','Đăng nhập thất bại. Xin vui lòng kiểm tra lại tài khoản hoặc mật khẩu!');
        }
     }
     ...
     public function loginAdmin(Request $request){
        ...
        {
            return redirect()->route('login.admin')->with('error','Đăng nhập thất bại. Xin vui lòng kiểm tra lại tài khoản hoặc mật khẩu!');
        }
     }
}
